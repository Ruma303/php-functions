...
echo "Fuori la funzione: $username.<br>";
stampaUsername(); */
...
function aggiungiCinque($numero) {
    $numero += 5;
    echo "Dentro la funzione: $numero <br>";
}
...
//function stampa(string|float|bool|array $value) {
    //function stampa(mixed $value) {
/* function stampa(?float $value): ?float {
    var_dump($value);
    echo '<br>';
    return $value;
} */
